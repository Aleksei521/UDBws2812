...
module top ;
	...
	wire [0:0] tmpOE__ws2812_port_net;
	wire [0:0] tmpFB_0__ws2812_port_net;
	wire [0:0] tmpIO_0__ws2812_port_net;
	wire [0:0] tmpINTERRUPT_0__ws2812_port_net;
	electrical [0:0] tmpSIOVREF__ws2812_port_net;
	...
	cy_psoc3_pins_v1_10
		...
		ws2812_port
		 (.oe(tmpOE__ws2812_port_net),
		  .y({Net_3}),
		  .fb({tmpFB_0__ws2812_port_net[0:0]}),
		  .io({tmpIO_0__ws2812_port_net[0:0]}),
		  .siovref(tmpSIOVREF__ws2812_port_net),
		  .interrupt({tmpINTERRUPT_0__ws2812_port_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ws2812_port_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
